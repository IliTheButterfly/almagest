...
server makes each one a single tool call instead of asking a model to learn 156
...
| 156 operations | 26 tools, each named for a question |
...
## 26 tools, and 130 deliberate refusals

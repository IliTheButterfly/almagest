...
server makes each one a single tool call instead of asking a model to learn 131
...
| 131 operations | 25 tools, each named for a question |
...
## 25 tools, and 106 deliberate refusals

The curation *is* the product. A model handed 131 tools chooses badly among them,

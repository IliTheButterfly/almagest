...
server makes each one a single tool call instead of asking a model to learn 158
...
| 158 operations | 26 tools, each named for a question |
...
## 26 tools, and 132 deliberate refusals

...
server makes each one a single tool call instead of asking a model to learn 169
...
| 169 operations | 26 tools, each named for a question |
...
## 26 tools, and 143 deliberate refusals

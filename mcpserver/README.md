...
server makes each one a single tool call instead of asking a model to learn 157
...
| 157 operations | 26 tools, each named for a question |
...
## 26 tools, and 131 deliberate refusals
